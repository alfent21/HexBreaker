...
export class UIController {
    ...
    init() {
        ...
        this.toolPaletteController.init({
            ...
            flipNormalBtn: this.elements.flipNormalBtn,
            pairMisslineCheckbox: this.elements.pairMisslineCheckbox,
            misslineOffsetGroup: this.elements.misslineOffsetGroup,
            misslineOffset: this.elements.misslineOffset,
            misslineOffsetValue: this.elements.misslineOffsetValue,
    ...
    _cacheElements() {
        this.elements = {
            ...
            flipNormalBtn: document.getElementById('btn-flip-normal'),
            pairMisslineCheckbox: document.getElementById('pair-missline-checkbox'),
            misslineOffsetGroup: document.getElementById('missline-offset-group'),
            misslineOffset: document.getElementById('missline-offset'),
            misslineOffsetValue: document.getElementById('missline-offset-value'),
